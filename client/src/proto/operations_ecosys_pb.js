...
goog.exportSymbol('proto.operations_ecosys.Query', null, global);
 ...
 * @constructor
 */
proto.operations_ecosys.Query = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.operations_ecosys.Query.repeatedFields_, null);
};
goog.inherits(proto.operations_ecosys.Query, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.operations_ecosys.Query.displayName = 'proto.operations_ecosys.Query';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.operations_ecosys.Query.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.operations_ecosys.Query.prototype.toObject = function(opt_includeInstance) {
  return proto.operations_ecosys.Query.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.operations_ecosys.Query} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.operations_ecosys.Query.toObject = function(includeInstance, msg) {
  var f, obj = {
    filtersList: jspb.Message.toObjectList(msg.getFiltersList(),
    proto.operations_ecosys.Filter.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.operations_ecosys.Query}
 */
proto.operations_ecosys.Query.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.operations_ecosys.Query;
  return proto.operations_ecosys.Query.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.operations_ecosys.Query} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.operations_ecosys.Query}
 */
proto.operations_ecosys.Query.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.operations_ecosys.Query.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.operations_ecosys.Query.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.operations_ecosys.Query} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.operations_ecosys.Query.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.operations_ecosys.Filter>}
 */
proto.operations_ecosys.Query.prototype.getFiltersList = function() {
  return /** @type{!Array<!proto.operations_ecosys.Filter>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.operations_ecosys.Filter, 1));
};


/**
 * @param {!Array<!proto.operations_ecosys.Filter>} value
 * @return {!proto.operations_ecosys.Query} returns this
*/
proto.operations_ecosys.Query.prototype.setFiltersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.operations_ecosys.Filter=} opt_value
 * @param {number=} opt_index
 * @return {!proto.operations_ecosys.Filter}
 */
proto.operations_ecosys.Query.prototype.addFilters = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.operations_ecosys.Filter, opt_index);
};
 ...
 * @return {!proto.operations_ecosys.Query} returns this
 */
proto.operations_ecosys.Query.prototype.clearFiltersList = function() {
 ...
 * @return {number}
 */
proto.operations_ecosys.Query.prototype.getLimit = function() {
 ...
 * @return {!proto.operations_ecosys.Query} returns this
 */
proto.operations_ecosys.Query.prototype.setLimit = function(value) {
