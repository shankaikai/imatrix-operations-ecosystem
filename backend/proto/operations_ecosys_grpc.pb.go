...
type CameraIotServicesClient interface {
	...
	GetIotState(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (CameraIotServices_GetIotStateClient, error)
}
...
func (c *cameraIotServicesClient) GetIotState(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (CameraIotServices_GetIotStateClient, error) {
...
type CameraIotServicesServer interface {
	...
	// Responses are sent only when there is a change in state
	// Upon connection, all states are sent for all locations are sent.
	GetIotState(*empty.Empty, CameraIotServices_GetIotStateServer) error
...
func (UnimplementedCameraIotServicesServer) GetIotState(*empty.Empty, CameraIotServices_GetIotStateServer) error {
