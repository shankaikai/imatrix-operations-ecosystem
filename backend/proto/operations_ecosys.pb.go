...
var file_proto_operations_ecosys_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x65, 0x63, 0x6f, 0x73, 0x79, 0x73, 0x2e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x14, 0x5a, 0x12, 0x2f, 0x6f,
	0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x65, 0x63, 0x6f, 0x73, 0x79, 0x73,
...
var file_proto_operations_ecosys_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_proto_operations_ecosys_proto_goTypes = []interface{}{
	...
	(*RosterAssignmentResponse)(nil),   // 34: operations_ecosys.RosterAssignmentResponse
	(*RosterFilter)(nil),               // 35: operations_ecosys.RosterFilter
	(*RosterQuery)(nil),                // 36: operations_ecosys.RosterQuery
	(*OrderByRoster)(nil),              // 37: operations_ecosys.OrderByRoster
	(*AvailabilityQuery)(nil),          // 38: operations_ecosys.AvailabilityQuery
	(*OrderByQuery)(nil),               // 39: operations_ecosys.OrderByQuery
	(*AvailabilityFilter)(nil),         // 40: operations_ecosys.AvailabilityFilter
	(*EmployeeEvaluationResponse)(nil), // 41: operations_ecosys.EmployeeEvaluationResponse
	(*EmployeeEvaluation)(nil),         // 42: operations_ecosys.EmployeeEvaluation
	(*Response)(nil),                   // 43: operations_ecosys.Response
	(*Filter)(nil),                     // 44: operations_ecosys.Filter
...
var file_proto_operations_ecosys_proto_depIdxs = []int32{
	...
	43, // 1: operations_ecosys.UsersResponse.response:type_name -> operations_ecosys.Response
	...
	44, // 4: operations_ecosys.UserFilter.comparisons:type_name -> operations_ecosys.Filter
	...
	43, // 9: operations_ecosys.ClientResponse.response:type_name -> operations_ecosys.Response
	...
	44, // 12: operations_ecosys.ClientFilter.comparisons:type_name -> operations_ecosys.Filter
	...
	45, // 18: operations_ecosys.Broadcast.creation_date:type_name -> google.protobuf.Timestamp
	45, // 19: operations_ecosys.Broadcast.deadline:type_name -> google.protobuf.Timestamp
	...
	45, // 25: operations_ecosys.BroadcastRecipient.last_replied:type_name -> google.protobuf.Timestamp
	43, // 26: operations_ecosys.BroadcastResponse.response:type_name -> operations_ecosys.Response
	...
	44, // 29: operations_ecosys.BroadcastFilter.comparisons:type_name -> operations_ecosys.Filter
	...
	42, // 38: operations_ecosys.RosterAssignement.guard_assigned:type_name -> operations_ecosys.EmployeeEvaluation
	45, // 39: operations_ecosys.RosterAssignement.custom_start_time:type_name -> google.protobuf.Timestamp
	45, // 40: operations_ecosys.RosterAssignement.custom_end_time:type_name -> google.protobuf.Timestamp
	45, // 41: operations_ecosys.RosterAssignement.attendance_time:type_name -> google.protobuf.Timestamp
	29, // 42: operations_ecosys.BulkRosters.rosters:type_name -> operations_ecosys.Roster
	43, // 43: operations_ecosys.RosterResponse.response:type_name -> operations_ecosys.Response
	29, // 44: operations_ecosys.RosterResponse.roster:type_name -> operations_ecosys.Roster
	43, // 45: operations_ecosys.RosterAssignmentResponse.response:type_name -> operations_ecosys.Response
	31, // 46: operations_ecosys.RosterAssignmentResponse.roster_assignment:type_name -> operations_ecosys.RosterAssignement
	8,  // 47: operations_ecosys.RosterFilter.field:type_name -> operations_ecosys.RosterFilter.Field
	44, // 48: operations_ecosys.RosterFilter.comparisons:type_name -> operations_ecosys.Filter
	35, // 49: operations_ecosys.RosterQuery.filters:type_name -> operations_ecosys.RosterFilter
	37, // 50: operations_ecosys.RosterQuery.order_by:type_name -> operations_ecosys.OrderByRoster
	...
	40, // 53: operations_ecosys.AvailabilityQuery.filters:type_name -> operations_ecosys.AvailabilityFilter
	39, // 54: operations_ecosys.AvailabilityQuery.order_by:type_name -> operations_ecosys.OrderByQuery
	...
	44, // 58: operations_ecosys.AvailabilityFilter.comparisons:type_name -> operations_ecosys.Filter
	43, // 59: operations_ecosys.EmployeeEvaluationResponse.response:type_name -> operations_ecosys.Response
	42, // 60: operations_ecosys.EmployeeEvaluationResponse.employee:type_name -> operations_ecosys.EmployeeEvaluation
	...
	32, // 78: operations_ecosys.RosterServices.UpdateRoster:input_type -> operations_ecosys.BulkRosters
	29, // 79: operations_ecosys.RosterServices.DeleteRoster:input_type -> operations_ecosys.Roster
	36, // 80: operations_ecosys.RosterServices.FindRosters:input_type -> operations_ecosys.RosterQuery
	38, // 81: operations_ecosys.RosterServices.GetAvailableUsers:input_type -> operations_ecosys.AvailabilityQuery
	36, // 82: operations_ecosys.RosterServices.FindRosterAssignments:input_type -> operations_ecosys.RosterQuery
	31, // 83: operations_ecosys.RosterServices.UpdateRosterAssignment:input_type -> operations_ecosys.RosterAssignement
	43, // 84: operations_ecosys.AdminServices.AddUser:output_type -> operations_ecosys.Response
	43, // 85: operations_ecosys.AdminServices.UpdateUser:output_type -> operations_ecosys.Response
	43, // 86: operations_ecosys.AdminServices.DeleteUser:output_type -> operations_ecosys.Response
	13, // 87: operations_ecosys.AdminServices.FindUsers:output_type -> operations_ecosys.UsersResponse
	43, // 88: operations_ecosys.AdminServices.AddClient:output_type -> operations_ecosys.Response
	43, // 89: operations_ecosys.AdminServices.UpdateClient:output_type -> operations_ecosys.Response
	43, // 90: operations_ecosys.AdminServices.DeleteClient:output_type -> operations_ecosys.Response
	18, // 91: operations_ecosys.AdminServices.FindClients:output_type -> operations_ecosys.ClientResponse
	43, // 92: operations_ecosys.BroadcastServices.AddBroadcast:output_type -> operations_ecosys.Response
	43, // 93: operations_ecosys.BroadcastServices.UpdateBroadcast:output_type -> operations_ecosys.Response
	43, // 94: operations_ecosys.BroadcastServices.DeleteBroadcast:output_type -> operations_ecosys.Response
	25, // 95: operations_ecosys.BroadcastServices.FindBroadcasts:output_type -> operations_ecosys.BroadcastResponse
	43, // 96: operations_ecosys.BroadcastServices.UpdateBroadcastRecipient:output_type -> operations_ecosys.Response
	43, // 97: operations_ecosys.RosterServices.AddRoster:output_type -> operations_ecosys.Response
	43, // 98: operations_ecosys.RosterServices.UpdateRoster:output_type -> operations_ecosys.Response
	43, // 99: operations_ecosys.RosterServices.DeleteRoster:output_type -> operations_ecosys.Response
	33, // 100: operations_ecosys.RosterServices.FindRosters:output_type -> operations_ecosys.RosterResponse
	41, // 101: operations_ecosys.RosterServices.GetAvailableUsers:output_type -> operations_ecosys.EmployeeEvaluationResponse
	34, // 102: operations_ecosys.RosterServices.FindRosterAssignments:output_type -> operations_ecosys.RosterAssignmentResponse
	43, // 103: operations_ecosys.RosterServices.UpdateRosterAssignment:output_type -> operations_ecosys.Response
