...
func request_WebAppServices_GetRosterAssignmentsForWebApp_0(ctx context.Context, marshaler runtime.Marshaler, client WebAppServicesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HTTPRosterMessage
	...
	val, ok = pathParams["roster_id"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "roster_id")
	}

	protoReq.RosterId, err = runtime.Int64(val)
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "roster_id", err)
	}
...
func RegisterWebAppServicesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WebAppServicesServer) error {
	...
	mux.Handle("GET", pattern_WebAppServices_GetRosterAssignmentsForWebApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/http_webapp.WebAppServices/GetRosterAssignmentsForWebApp", runtime.WithHTTPPathPattern("/http/rosters/{roster_id}"))
		if err != nil {
...
func RegisterWebAppServicesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WebAppServicesClient) error {
	...
	mux.Handle("GET", pattern_WebAppServices_GetRosterAssignmentsForWebApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/http_webapp.WebAppServices/GetRosterAssignmentsForWebApp", runtime.WithHTTPPathPattern("/http/rosters/{roster_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_WebAppServices_GetRosterAssignmentsForWebApp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"http", "rosters", "roster_id"}, ""))
