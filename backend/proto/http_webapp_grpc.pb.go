...
type WebAppServicesClient interface {
	...
	PostWReportFromWebApp(ctx context.Context, in *HTTPMessage, opts ...grpc.CallOption) (*HTTPMessage, error)
}
...
func (c *webAppServicesClient) PostWReportFromWebApp(ctx context.Context, in *HTTPMessage, opts ...grpc.CallOption) (*HTTPMessage, error) {
	out := new(HTTPMessage)
...
type WebAppServicesServer interface {
	...
	PostWReportFromWebApp(context.Context, *HTTPMessage) (*HTTPMessage, error)
...
func (UnimplementedWebAppServicesServer) PostWReportFromWebApp(context.Context, *HTTPMessage) (*HTTPMessage, error) {
...
func _WebAppServices_PostWReportFromWebApp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebAppServicesServer).PostWReportFromWebApp(ctx, req.(*HTTPMessage))
	}
	return interceptor(ctx, in, info, handler)
}
